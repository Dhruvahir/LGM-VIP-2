...
function App() {
  ...
  return (
    <div className="app">
      <nav>
        <div className="title"><p>• Done By Dhruv Ahir  </p> </div>
        <div className="middle">
        <button onClick={() => getUsers()} className="btn push">
          Get Users
        </button>
        <h1> Click on Get Users button to see API'S of Users</h1>
        </div>
        <h4>
        Let's Grow More Internship<br />
          ᴡᴇʙ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴛᴀꜱᴋ 2</h4>
      </nav>
      <div className="users">
        {users.map(user => (
          <div>
